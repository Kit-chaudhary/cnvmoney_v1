...
const data = [
  ...
  },
  {
    ...
    info: `is an IRDA registered Insurance Broker. The company provides both Life and Non-life Insurance solutions offline as well as online through state of the art portal www.policybasket.in One can select, compare, buy, renew & manage their policies online from anywhere through the portal & mobile application.`,
  },
  {
    imageUrl: "/about/4.png",
    header: "MAHARASHTRA CO-OP CREDIT SOCIETY Ltd",
    info: `As We Look Back At This 33-Year Long Journey, It Is For Everyone To See How All These Objectives Have Been Successfully Achieved, While Also Creating New Landmarks Along The Way. The Journey Of  Maharashtra  Co-operative   Society   That Started On August 16, 1991, From A Small Room Has Grown By Leaps And Bounds And Evolved Into A Network Of 6 Branches Across Maharashtra. The Operations Of The Network, Which Are Growing By The Day, Are Spearheaded From The Regional Offices Of  Maharashtra  Co-operative  Society  , Located At Vasai-Palghar, Maharashtra. Today,  Maharashtra  Co-operative  Society Has Established Itself As India’s Fastest Growing Co-operative Credit Society.`,
  },
];
    ...
    <>
      <div className="p-2 text-wrap mb-1">
        ...
        <p className="text-gray-500 mt-2">
          ...
          what defines&quot Credit & Vault Investments&quot; .With a vision to
          create a WOW experience, we extend unbiased, accurate, and independent
