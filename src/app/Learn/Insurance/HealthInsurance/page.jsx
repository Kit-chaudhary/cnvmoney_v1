...
import TableOfContents from "../../../Component/Table of Content/TableOfContents";
        ...
        <div>
          ...
          <div className="Insurance-main">
            ...
            <p>
              ...
              assistance for medical and hospital expenses. Pays the secretary
              for medical expenses incurred due to illness or injury, according
              to the terms and conditions of the policy. Health insurance
              policies in India are provided by various public and private
              insurance companies. These policies are designed to cover a wide
              range of medical expenses, including hospital fees, medical
              expenses, medical examinations, surgeries, and other medical
              expenses.
            </p>
            ...
            <ul>
              ...
              <li>
                ...
                <p>
                  This policy covers the health expenses of the whole family.
                  The insured pay only one premium and the whole family is
                  insured.
                </p>
              </li>
              <li>
              ...
              <li>
                ...
                <p>
                  ...
                  Covers critical medical expenses such as The right to an
                  income payment if the insured is diagnosed with a medical
                  condition.
                </p>
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                ...
                <p>
                  The Health Insurance Policy is renewable for life. This
                  ensures that policyholders are insured for their entire life.
                </p>
              </li>
            </ul>

            <div id="header4">
              <h2>In Summary,</h2>Health Insurance is an important financial
              instrument that protects individuals and families from high
              medical costs. There are many health insurance policies available
              in India so it is important to choose a policy based on one{"'"}s
              needs and budget.
            </div>
          </div>
        </div>
