...
export default function RootLayout({
  ...
  const menu = [
    ...
    { name: "Properties", url: "/Learn/Properties" },
    { name: "Liquiloans", url: "/Learn/Liquiloans" },
    { name: "Smallcases", url: "/Learn/Smallcases" },
    { name: "Holidays", url: "/Learn/Holidays" },
  ];

  const router = usePathname();

  return (
    <div className="pt-24 px-5 bg-slate-50">
