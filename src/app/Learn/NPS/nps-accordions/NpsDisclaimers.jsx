    ...
    <Accordion>
      ...
      <AccordionDetails>
        ...
        <p className="text-gray-500 nps_para mt-2">
          ...
          Technologies Limited” and &quot;K-Fintech&quot; to customer.
        </p>
        <p className="text-gray-500 nps_para mt-2">
        ...
        <p className="text-gray-500 nps_para mt-2">
          ...
          provided by the selected CRA (Protean eGov Technologies Limited or
          K-Fin Technologies Pvt. Ltd.) to the customer.
        </p>
      </AccordionDetails>
    </Accordion>
  );
